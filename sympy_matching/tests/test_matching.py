# -*- coding: utf-8 -*-
"""Tests for pattern matching on SymPy expressions using MatchPy.
...
class TestBasicPatternMatching:
    """Test basic pattern matching on SymPy-derived MatchPy expressions.
...
class TestTrigSimplification:
    ...
    def _make_trig_replacer(self):
        ...
        rule = matchpy_functions.ReplacementRule(trig_pattern, trig_replacement)
...
class TestPowerRules:
    ...
    def _make_power_replacer(self):
        ...
        return ManyToOneReplacer(
            ...
            matchpy_functions.ReplacementRule(pattern_one, replace_one),
            matchpy_functions.ReplacementRule(pattern_power_of_power, replace_power_of_power),
        )
