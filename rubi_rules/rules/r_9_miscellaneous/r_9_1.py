...
from rubi_rules.utils import (
    ...
    FreeQ, IntegerQ, MatchQ, EqQ, IGtQ, ILtQ, GtQ, LtQ, LeQ, NegQ,
    RationalQ, SumQ, PolyQ, LinearQ, SimplerQ, FunctionOfQ, InverseFunctionQ,
)
...
RULES = [
    ...
    RubiRulePattern(
        pattern=Int(-u_, x),
        constraints=(),
        replacement=-Int(u_, x),
        module_name='9.1 Derivative integration rules',
        rule_number=31,
    ),
    # Rule 32
    RubiRulePattern(
        pattern=Int(I*a_*u_, x),
        constraints=(FreeQ(a_, x), EqQ(a_**2, 1),),
        replacement=I*a_*Int(u_, x),
        module_name='9.1 Derivative integration rules',
        rule_number=32,
    ),
    # Rule 33
