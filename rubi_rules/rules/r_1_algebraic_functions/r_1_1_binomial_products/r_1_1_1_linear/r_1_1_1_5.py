...
RULES = [
    ...
    RubiRulePattern(
        pattern=Int(Px_*(x*_b_ + _a_)**_m_*(x*_d_ + _c_)**_n_, x),
        constraints=(FreeQ([_a_, _b_, _c_, _d_, _m_, _n_], x), PolyQ(Px_, x), GtQ(Expon(Px_, x), 2),),
        replacement=With(List(Set(Symbol('q'), Expon(Px_, x)), Set(Symbol('k'), Coeff(Px_, x, Expon(Px_, x)))), Condition(((Symbol('k') * ((_a_ + (_b_ * x)))**((_m_ + Symbol('q'))) * ((_c_ + (_d_ * x)))**((_n_ + Integer(1))) * ((_d_ * (_b_)**(Symbol('q')) * (_m_ + _n_ + Symbol('q') + Integer(1))))**(Integer(-1))) + (((_d_ * (_b_)**(Symbol('q')) * (_m_ + _n_ + Symbol('q') + Integer(1))))**(Integer(-1)) * Int((((_a_ + (_b_ * x)))**(_m_) * ((_c_ + (_d_ * x)))**(_n_) * ExpandToSum(((_d_ * (_b_)**(Symbol('q')) * (_m_ + _n_ + Symbol('q') + Integer(1)) * Px_) + (Integer(-1) * (_d_ * Symbol('k') * (_m_ + _n_ + Symbol('q') + Integer(1)) * ((_a_ + (_b_ * x)))**(Symbol('q')))) + (Integer(-1) * (Symbol('k') * ((_b_ * _c_) + (Integer(-1) * (_a_ * _d_))) * (_m_ + Symbol('q')) * ((_a_ + (_b_ * x)))**((Symbol('q') + Integer(-1)))))), x)), x))), NeQ((_m_ + _n_ + Symbol('q') + Integer(1)), Integer(0)))),
        module_name='1.1.1.5 P(x) (a+b x)^m (c+d x)^n',
        rule_number=8,
    ),
